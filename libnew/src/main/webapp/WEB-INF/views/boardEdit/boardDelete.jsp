									...
									<tr>
										<td>
											<div id="bookInfomation">
												<form:form
													action="${pageContext.request.contextPath}/boardDeleteDone"
													commandName="delboard">
													<p>
														<input type="text" name="boardTitle"
															value="${deleteBoard.boardTitle}" readonly style="border: none; background: transparent;">
													</p>
													<p>이 글을 삭제하시겠습니까?</p>
													<p>
