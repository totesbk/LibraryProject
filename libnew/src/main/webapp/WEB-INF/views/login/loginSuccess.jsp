...
<body>
	...
	<div id="fullpage">
		...
		<div class="fullsection full4"
			style="background-image: url(${pageContext.request.contextPath}/resources/img/m14.jpg);">
			<table id="td">
				<tr>
					<td height="100px"></td>
				</tr>
					...
					<td>
						<div id="box4">
							...
							<div id="policy">
								<table>
									<tr height="50px">
										<th width="550px">${authInfo.name}님 환영합니다.</th>
									</tr>
									<tr>
										<th height="50px"><a href="<c:url value='/main'/>"> [메인으로 가기]
										</a></th>
									</tr>
								</table>
							</div>
