									...
									<tr>
										<td>
											<div id="bookList">
												<c:if test="${!empty books}">
													<table id="boardTable">
														...
														<c:forEach var="m" items="${books}">
															<tr>
																<th height="25px">${m.id}</th>
																<td>&nbsp;&nbsp;&nbsp;&nbsp;<a
																	href="<c:url value="/library/bookdetail/${m.id}"/>">${m.bookname}</a>
																</td>
																<td>&nbsp;&nbsp;&nbsp;&nbsp;${m.bookgenre}</td>
																<td>&nbsp;&nbsp;&nbsp;&nbsp;${m.bookauthor}</td>
																<td>&nbsp;&nbsp;&nbsp;&nbsp;<fmt:formatDate
																		value="${m.registerDate}" pattern="yyyy-MM-dd" /></td>
															</tr>
															<tr>
																<td colspan="5">
																	<hr color="whitesmoke">
												...
												<a href="<c:url value="/bookSearch"/>">
													<div id="button">도서 검색</div>
												</a>
												<c:if test="${!empty authInfo.authority}">
													<a href="<c:url value="/write/writebook"/>">
														<div id="button">도서 등록</div>
													</a>
													<br>
												</c:if>
												<br>
